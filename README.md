# [SOLVED] Git-Clone-Authentication-Failed-For-Lt-Url-Gt
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/git-clone-authentication-failed-for-lt-url-gt)
>
...
Try using the corporate network's SSH credentials or configure Git to use the Windows username and password.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/git-clone-authentication-failed-for-lt-url-gt)**
